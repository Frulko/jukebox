...
const DOCS: Record<string, Doc> = {
  ...
  'GET /tracks': { summary: 'One page of tracks, with device presence and renditions.', returns: 'Page<Track>', tag: 'library', query: ['sort', 'cursor', 'limit', 'q', 'genre', 'artist', 'album', 'format', 'tag', 'kind', 'sourceId', 'rating', 'ratingMin', 'lossless', 'onDevice', 'notOnDevice', 'match'] },
