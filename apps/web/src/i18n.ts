...
const fr = {
  ...
  Download: 'Télécharger', 'Download {n} Episodes': 'Télécharger {n} épisodes',
  'Find the book on…': 'Chercher le livre sur…',
  Music: 'Musique', Uploading: 'Envoi', 'Drop to add to {where}': 'Déposer pour ajouter à {where}',
...
const it = {
  ...
  Download: 'Scarica', 'Download {n} Episodes': 'Scarica {n} episodi',
  'Find the book on…': 'Cerca il libro su…',
  Music: 'Musica', Uploading: 'Invio', 'Drop to add to {where}': 'Rilascia per aggiungere a {where}',
...
const es = {
  ...
  Download: 'Descargar', 'Download {n} Episodes': 'Descargar {n} episodios',
  'Find the book on…': 'Buscar el libro en…',
  Music: 'Música', Uploading: 'Subiendo', 'Drop to add to {where}': 'Suelta para añadir a {where}',
...
const de = {
  ...
  Download: 'Laden', 'Download {n} Episodes': '{n} Folgen laden',
  'Find the book on…': 'Das Buch suchen auf…',
  Music: 'Musik', Uploading: 'Hochladen', 'Drop to add to {where}': 'Zum Hinzufügen zu {where} ablegen',
